...
@Component({
    selector: 'app-euroscore',
    templateUrl: './euroscore.component.html'
})
export class EuroScoreDetailsComponent implements OnInit {
    ...
    saveEuroScore() {
        ...
        this.patient.updatePatient(this.wl, this.auth.decodedToken.nameid).subscribe((next) => { })
    }
    ...
    saveES() { this.saveEuroScore(); this.alertify.message('Euroscore details Saved ...');}
