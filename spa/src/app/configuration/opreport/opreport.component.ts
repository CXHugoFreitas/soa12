...
@Component({
    ...
    styleUrls: ['./opreport.component.scss']
})
...
export class OpreportComponent{
    ...
    editReport() {
        ...
        if(this.procedures.length === 0){
            this.alertify.message("For this to work you must have saved at least one procedure template");
        } else
        {
        this.edit = '1';
    ...
    saveChanges()
    {
        ...
        {
            this.edit = '0';
        }, (error) => { this.alertify.error('Report was not saved ...' + error); });
    }
    ...
    showEditDetails() {
        if (this.edit === '1') { return true; } else { return false; } }
